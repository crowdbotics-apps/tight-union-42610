"""
Django settings for tight_union_42610 project.
...
ROOT_URLCONF = 'tight_union_42610.urls'
...
WSGI_APPLICATION = 'tight_union_42610.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tight_union_42610 API",
    "DESCRIPTION": "API documentation for tight_union_42610 App",
    "VERSION": "v1",
}
